...
import productPic from '../images/product4.jpg'
...
const Hero = () => {
  return (
    <Box backgroundColor="#FFA8E2" w="100%" position="relative" h="70vh">
      ...
      <Text className="tracking-in-expand-fwd" position="absolute" bottom="15%" w="100%" textAlign="center" color="white" fontWeight="bold" fontSize="5rem">
        Fresh Mood
      </Text>
      <Center>
